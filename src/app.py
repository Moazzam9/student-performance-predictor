...
st.markdown(
    """
    This app predicts a student's final exam score based on study habits, sleep, attendance,
    previous performance, extracurricular activities, class participation, and stress level.
    """
)
